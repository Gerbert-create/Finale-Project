...
function MobileMenu(props) {
	...
	return (
		<div className={`mobileMenu ${props.menuState}Menu`}>
			<ul className="text mobileMenu__menu">
				...
				{props.token === ''
					? 	<>
							...
							<li onClick={() => onClickSignUp()} className="mobileMenu__item">Регистрация</li>
						</>
				// если пользователь зашёл, то рендерится кнопка "Выйти"
					:	<li onClick={() => onLogOut()} className="mobileMenu__item">Выйти</li>
				}
