...
function Header(props) {
	...
	return (
		<>
				...
				<div className='text header__header-block'>
					...
					<div className='header__menu'>
						...
						{props.user.approved === true
							? <>
								<Link to='/messageList'><span>Сообщений</span></Link>
			...
			*/}
			{menuClick === 'active'
				? <MobileMenu onItemsClick={OnItemsMenuClick} menuState={menuClick} funcOnClickLogIn={OnClickLogIn} funcOnClickSignUp={OnClickSignUp} funcLogOut={OnLogOut} />
				: null
			}
